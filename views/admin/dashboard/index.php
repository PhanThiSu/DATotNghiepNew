  ...
  <div class="row">
    ...
    <div class="col-lg-6 .col-md-6 .col-sm-12">
      ...
      <div class="small-box bg-green  small-dashboard">
        <div class="inner">
          <h3 class="smallMobileHide"><a class="daily" alt="today" href="<?=vendor_app_util::url(['ctl' => 'reports', 'act' => 'daily']);?>"> <?=$this->noUsersTodayReports;?> Nhân viên báo cáo hôm nay</a></h3>
        ...
        <a href="<?=vendor_app_util::url(['ctl' => 'reports', 'act' => 'daily']);?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <!-- ./col -->
    <div class="col-lg-6 .col-md-6 .col-sm-12">
      ...
      <div class="small-box bg-yellow small-dashboard">
        <div class="inner">
          <h3 class="smallMobileHide"><a  class="daily" alt="today" href="<?=vendor_app_util::url(['ctl' => 'requests', 'act' => 'daily']);?>"><?=$this->noTodayRequests;?> Nhân viên xin nghỉ hôm nay</a></h3>
        ...
        <a href="<?=vendor_app_util::url(['ctl' => 'requests', 'act' => 'daily']);?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
      </div>
      <!-- cmt đoạn trên -->
    </div>
    <!-- ./col -->
