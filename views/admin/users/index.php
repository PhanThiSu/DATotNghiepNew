...
<?php vendor_html_helper::contentheader('Quản lý người dùng', [['urlp'=>['ctl'=>"", 'act'=>"Danh sách người dùng"]]]); ?>
			    ...
			    <div class="box-header">
		    		<div class="row" id="records-header">
		    			...
		    			<div class="col-sm-4 col-xs-6">
		    				...
		    				<a href="<?=vendor_app_util::url(array('ctl'=>'users', 'act'=>'add')); ?>" id="add-record" type = "button" class="btn btn-primary pull-right" >
